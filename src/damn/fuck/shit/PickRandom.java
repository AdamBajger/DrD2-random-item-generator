...
import static damn.fuck.shit.ResourceTypes.SOUL;
...
public class PickRandom {
    ...
    /**
     * This is the default version of {@link PickRandom#GeneralAbility} with region parameter and AbilityType parameter omitted.
     * @see PickRandom#GeneralAbility(double, String, AbilityType)
     */
    ...
    /**
     * This is the default version of {@link PickRandom#GeneralAbility} with AbilityType parameter omitted.
     * @see PickRandom#GeneralAbility(double, String, AbilityType)
     */
    ...
    /**
     * This is a version of {@link PickRandom#GeneralAbility} with region parameter omitted.
     * @see PickRandom#GeneralAbility(double, String, AbilityType)
     */
    ...
    public static ItemAbility GeneralAbility(double maxRarity, String region, AbilityType abilityType) throws IllegalArgumentException {
        ...
        String csvFilePath = "src\\damn\\fuck\\shit\\abilitiesGeneral.csv";
    ...
    /**
     * This is a {@link PickRandom#weaponOfType(double, WeaponType, byte, Material)} version, with some default values.
     ...
     * @see PickRandom#weaponOfType(double, WeaponType, byte, Material)
     */
    ...
    public static Weapon weaponOfType(double maxRarity, WeaponType weaponType, byte weaponQuality, Material weaponMaterial) throws IllegalArgumentException {
        ...
        String csvFilePath = "src\\damn\\fuck\\shit\\" + weaponType + ".csv";
        BufferedReader br = null;
        String line; //= "";
        String[] content; // Array containing particular values stored in single CSV line
...
/*
            ...
            File file = new File("src\\damn\\fuck\\shit\\TEST.csv");
            if (!file.exists()) {
                try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                for(short pls = 0; pls < skippedLines; pls++) {
                    ...
                    if((line = br.readLine()) == null) {
                        ...
                        return PickRandom.weaponOfType(maxRarity, weaponType, weaponQuality, weaponMaterial);
                    }
                }
