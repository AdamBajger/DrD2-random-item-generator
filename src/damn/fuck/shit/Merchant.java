...
public class Merchant implements java.io.Serializable {
    public static String DEFAULT_OBJ_STOR_DIR = "src/damn/fuck/shit/";
    ...
    public void createSortiment(String region) {
        ...
        for(short i = 0; i < currentItemAmount; i++) {
            ...
            sortiment[h] = PickRandom.weaponOfType(
                    leftoverBaseRarity,
            ...
            if(sellingMagic) {
                ...
                ItemAbility randomAbility = PickRandom.GeneralAbility(leftoverAbilityRarity, region);
                ...
                while(leftoverAbilityRarity >= ItemAbility.MIN_RARITY_VALUE && RandomGenerator.RANDOM.nextBoolean()) {
                    if(!sortiment[h].getAbilities().contains(randomAbility = PickRandom.GeneralAbility(leftoverAbilityRarity, region))) {
                        sortiment[h].addAbility(randomAbility);
                        leftoverAbilityRarity -= randomAbility.getRarity();
                    }
                }
